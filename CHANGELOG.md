...
- Cron/manual runs: route dashboard and API `cron.run` isolated jobs through a separate dispatch lane so manual triggers no longer enqueue successfully and then deadlock before spawning their isolated session. Fixes #41507. Thanks @sahancava.
